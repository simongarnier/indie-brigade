...
class OpeningsControllerTest < ActionController::TestCase
  ...
  test "should create opening" do
    assert_difference('Opening.count') do
      post :create, opening: { availability_id: @opening.availability_id, name: @opening.name, role_id: @opening.role_id }
    end
  ...
  test "should update opening" do
    patch :update, id: @opening, opening: { availability_id: @opening.availability_id, name: @opening.name, role_id: @opening.role_id }
    assert_redirected_to opening_path(assigns(:opening))
  end
